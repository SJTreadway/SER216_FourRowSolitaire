...
public class SolitaireLayout implements LayoutManager
{
    ...
    public static final String SPADES_ACE_PILE = "Spades Ace Pile";
    ...
    public void layoutContainer(Container parent)
    {
        ...
        if((comp = colOne) != null)
        {
        comp.setBounds(190,180,72,800);
        }
        if((comp = colTwo) != null)
        {
        comp.setBounds(360,180,72,800);
        }
        if((comp = colThree) != null)
        {
        comp.setBounds(530,180,72,800);
        }
        if((comp = colFour) != null)
        {
        comp.setBounds(700,180,72,800);
        }

        if((comp = aceSpades) != null)
        {
        comp.setBounds(1170,10,72,96);
        }
        if((comp = aceClubs) != null)
        {
        comp.setBounds(1340,10,72,96);
        }
        if((comp = aceDiamonds) != null)
        {
        comp.setBounds(1170,140,72,96);
        }
        if((comp = aceHearts) != null)
        {
        comp.setBounds(1340,140,72,96);
        }

        if((comp = discardPile) != null)
        {
        comp.setBounds(1340,395,72,96);
        }
        if((comp = deck) != null)
        {
        comp.setBounds(1170,395,72,96);
        }

        if((comp = cellOne) != null)
        {
        comp.setBounds(190,10,72,96);
        }
        if((comp = cellTwo) != null)
        {
        comp.setBounds(360,10,72,96);
        }
        if((comp = cellThree) != null)
        {
        comp.setBounds(530,10,72,96);
        }
        if((comp = cellFour) != null)
        {
        comp.setBounds(700,10,72,96);
        }
    }
}